...
class mtcnn():
    def __init__(self):
        self.Pnet = create_Pnet('./export_models/pnet.h5')
        self.Rnet = create_Rnet('./export_models/rnet.h5')
        self.Onet = create_Onet('./export_models/onet.h5')
    ...
    def detectFace(self, img, threshold):
        ...
        for rectangle in rectangles:
            ...
            #   利用获取到的粗略坐标，在原图上进行截取
            #------------------------------------------#
            crop_img = copy_img[int(rectangle[1]):int(
